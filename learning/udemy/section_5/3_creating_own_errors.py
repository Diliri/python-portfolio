...
"""
The `pass` keyword just means “nothing here”. It is required because Python expects there to be an indented block after a colon,
...
err = MyErrorWithCode('Ouch! An error happened!', 500)
print(err)          # Error code 500: Ouch! An error happened!
