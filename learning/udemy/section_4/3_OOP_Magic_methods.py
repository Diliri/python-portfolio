...
method is called with the new object as `self` and the string you passed as `'name'`.
"""
...
print(movies.__class__)  # what's this? class of a list
...
print(garage)           # Garage with 2 cars
print(str(garage))      # Garage with 2 cars
print(repr(garage))     # Garage ['Fiesta', 'Focus']


## More
"""
There are many magic “dunder” methods you can implement, 
including some to overload what mathematical operators do, 
